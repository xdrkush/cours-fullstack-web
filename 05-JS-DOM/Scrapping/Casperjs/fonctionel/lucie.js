...
casper.start('https://cuisine-sans-gluten-ni-lactose.blogspot.com/search/label/LES%20G%C3%82TEAUX', function() {
  ...
  const
    getLinks = this.evaluate(function() {
      ...
      const
          linkArray = document.querySelectorAll('div.section div.widget div.post div.post-body meta')
